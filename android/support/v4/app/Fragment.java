...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C00031 implements Creator<SavedState> {
            C00031() {
            }
    ...
    class C03131 implements FragmentContainer {
        C03131() {
        }
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachActivity(this.mActivity, new C03131(), this);
    }
