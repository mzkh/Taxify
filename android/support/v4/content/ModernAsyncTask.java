...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    class C00173 extends FutureTask<Result> {
        C00173(Callable x0) {
            super(x0);
        }
    ...
    class C03182 extends WorkerRunnable<Params, Result> {
        C03182() {
            super();
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C03182();
        this.mFuture = new C00173(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00184.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
