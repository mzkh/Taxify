...
public final class RatingCompat implements Parcelable {
    ...
    static class C00211 implements Creator<RatingCompat> {
        C00211() {
        }
    ...
    public static RatingCompat newHeartRating(boolean hasHeart) {
        return new RatingCompat(RATING_HEART, hasHeart ? TextTrackStyle.DEFAULT_FONT_SCALE : 0.0f);
    }

    public static RatingCompat newThumbRating(boolean thumbIsUp) {
        return new RatingCompat(RATING_THUMB_UP_DOWN, thumbIsUp ? TextTrackStyle.DEFAULT_FONT_SCALE : 0.0f);
    }
    ...
    public boolean hasHeart() {
        ...
        if (this.mRatingValue != TextTrackStyle.DEFAULT_FONT_SCALE) {
            z = false;
        }
        return z;
    }
    ...
    public boolean isThumbUp() {
        if (this.mRatingStyle == RATING_THUMB_UP_DOWN && this.mRatingValue == TextTrackStyle.DEFAULT_FONT_SCALE) {
            return true;
        }
        return false;
    }
