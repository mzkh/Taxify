...
public class TransportMediator extends TransportController {
    ...
    class C00222 implements Callback {
        C00222() {
        }
    ...
    class C03191 implements TransportMediatorCallback {
        C03191() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C03191();
        this.mKeyEventCallback = new C00222();
