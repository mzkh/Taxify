...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    ...
    class C00231 implements OnWindowAttachListener {
        C00231() {
        }
    ...
    class C00242 implements OnWindowFocusChangeListener {
        C00242() {
        }
    ...
    class C00253 extends BroadcastReceiver {
        C00253() {
        }
    ...
    class C00264 implements OnAudioFocusChangeListener {
        C00264() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C00231();
        this.mWindowFocusListener = new C00242();
        this.mMediaButtonReceiver = new C00253();
        this.mAudioFocusChangeListener = new C00264();
        this.mPlayState = 0;
    ...
    public void refreshState(boolean playing, long position, int transportControls) {
        if (this.mRemoteControl != null) {
            this.mRemoteControl.setPlaybackState(playing ? 3 : 1, position, playing ? TextTrackStyle.DEFAULT_FONT_SCALE : 0.0f);
