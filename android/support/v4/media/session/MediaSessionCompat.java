...
public class MediaSessionCompat {
    ...
    public static final class QueueItem implements Parcelable {
        ...
        static class C00301 implements Creator<QueueItem> {
            C00301() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        ...
        static class C00311 implements Creator<ResultReceiverWrapper> {
            C00311() {
            }
    ...
    public static final class Token implements Parcelable {
        ...
        static class C00321 implements Creator<Token> {
            C00321() {
            }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class C03211 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C03211() {
            }
        ...
        class C03222 implements android.support.v4.media.session.MediaSessionCompatApi14.Callback {
            final /* synthetic */ Callback val$callback;

            C03222(Callback callback) {
        ...
        public MediaSessionImplBase(Context context, String tag, ComponentName mbrComponent, PendingIntent mbr) {
            ...
            this.mVolumeCallback = new C03211();
        ...
        public void setCallback(Callback callback, Handler handler) {
            if (callback != this.mCallback) {
                if (callback == null || VERSION.SDK_INT < 18) {
                    ...
                    android.support.v4.media.session.MediaSessionCompatApi14.Callback cb14 = new C03222(callback);
                    if (VERSION.SDK_INT >= 18) {
        ...
        public void setMetadata(MediaMetadataCompat metadata) {
            ...
            if (VERSION.SDK_INT >= 19) {
                ...
                MediaSessionCompatApi19.setMetadata(obj, bundle, canRate);
            } else if (VERSION.SDK_INT >= 14) {
                obj = this.mRccObj;
                if (metadata != null) {
                    bundle = metadata.getBundle();
