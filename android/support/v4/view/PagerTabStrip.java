...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(Context context, AttributeSet attrs) {
        ...
        this.mFullUnderlineHeight = (int) ((TextTrackStyle.DEFAULT_FONT_SCALE * density) + 0.5f);
        ...
        this.mPrevText.setOnClickListener(new C00491());
        this.mNextText.setFocusable(true);
        this.mNextText.setOnClickListener(new C00502());
