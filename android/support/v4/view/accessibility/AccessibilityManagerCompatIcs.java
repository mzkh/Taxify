...
class AccessibilityManagerCompatIcs {
    ...
    static class C00611 implements AccessibilityStateChangeListener {
        final /* synthetic */ AccessibilityStateChangeListenerBridge val$bridge;

        C00611(AccessibilityStateChangeListenerBridge accessibilityStateChangeListenerBridge) {
