...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    class C00721 extends Animation {
        ...
        public void applyTransformation(float interpolatedTime, Transformation t) {
            ...
            float minProgressArc = (float) Math.toRadians(((double) this.val$ring.getStrokeWidth()) / (6.283185307179586d * this.val$ring.getCenterRadius()));
            ...
            this.val$ring.setEndTrim(startingEndTrim + (MaterialProgressDrawable.START_CURVE_INTERPOLATOR.getInterpolation(interpolatedTime) * (MaterialProgressDrawable.MAX_PROGRESS_ARC - minProgressArc)));
            this.val$ring.setStartTrim(startingTrim + (MaterialProgressDrawable.MAX_PROGRESS_ARC * MaterialProgressDrawable.END_CURVE_INTERPOLATOR.getInterpolation(interpolatedTime)));
    ...
    class C00732 implements AnimationListener {
        final /* synthetic */ Ring val$ring;
        ...
        public void onAnimationRepeat(Animation animation) {
            ...
            MaterialProgressDrawable.this.mRotationCount = (MaterialProgressDrawable.this.mRotationCount + TextTrackStyle.DEFAULT_FONT_SCALE) % MaterialProgressDrawable.NUM_POINTS;
        }
    }

    /* renamed from: android.support.v4.widget.MaterialProgressDrawable.3 */
    class C00743 implements Callback {
        C00743() {
        }
    ...
    private static class Ring {
        ...
        public void goToNextColor() {
            this.mColorIndex = (this.mColorIndex + MaterialProgressDrawable.DEFAULT) % this.mColors.length;
        }
    ...
    private static class StartCurveInterpolator extends AccelerateDecelerateInterpolator {
        ...
        public float getInterpolation(float input) {
            return super.getInterpolation(Math.min(TextTrackStyle.DEFAULT_FONT_SCALE, 2.0f * input));
        }
    }
    ...
    private void setupAnimators() {
        Ring ring = this.mRing;
        Animation animation = new C00721(ring);
        animation.setRepeatCount(-1);
        animation.setRepeatMode(DEFAULT);
        animation.setInterpolator(LINEAR_INTERPOLATOR);
        animation.setAnimationListener(new C00732(ring));
