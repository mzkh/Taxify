...
class SearchViewCompatHoneycomb {
    ...
    static class C00751 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C00751(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C00762 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C00762(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
