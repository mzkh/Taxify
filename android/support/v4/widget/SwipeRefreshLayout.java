...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    class C00791 implements AnimationListener {
        C00791() {
        }
    ...
    class C00802 extends Animation {
        C00802() {
        }
    ...
    class C00813 extends Animation {
        C00813() {
        }
    ...
    class C00824 extends Animation {
    ...
    class C00835 implements AnimationListener {
        C00835() {
        }
    ...
    class C00846 extends Animation {
        C00846() {
        }
    ...
    class C00857 extends Animation {
        C00857() {
        }
    ...
    class C00868 extends Animation {
        C00868() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mRefreshListener = new C00791();
        this.mAnimateToCorrectPosition = new C00846();
        this.mAnimateToStartPosition = new C00857();
    ...
    private void startScaleUpAnimation(AnimationListener listener) {
        ...
        this.mScaleAnimation = new C00802();
    ...
    private void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new C00813();
    ...
    private Animation startAlphaAnimation(int startingAlpha, int endingAlpha) {
        ...
        Animation alpha = new C00824(startingAlpha, endingAlpha);
    ...
    private void startScaleDownReturnToStartAnimation(int from, AnimationListener listener) {
        ...
        this.mScaleDownToStartAnimation = new C00868();
