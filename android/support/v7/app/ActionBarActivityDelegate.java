...
abstract class ActionBarActivityDelegate {
    ...
    /* renamed from: android.support.v7.app.ActionBarActivityDelegate.1 */
    class C03351 implements WindowCallback {
        C03351() {
        }
    ...
    ActionBarActivityDelegate(ActionBarActivity activity) {
        this.mDefaultWindowCallback = new C03351();
    ...
    void onCreate(Bundle savedInstanceState) {
        ...
        if (a.hasValue(C0093R.styleable.Theme_windowActionBar)) {
            if (a.getBoolean(C0093R.styleable.Theme_windowActionBar, false)) {
                this.mHasActionBar = true;
            }
            if (a.getBoolean(C0093R.styleable.Theme_windowActionBarOverlay, false)) {
                this.mOverlayActionBar = true;
            }
            if (a.getBoolean(C0093R.styleable.Theme_windowActionModeOverlay, false)) {
                this.mOverlayActionMode = true;
            }
            this.mIsFloating = a.getBoolean(C0093R.styleable.Theme_android_windowIsFloating, false);
            a.recycle();
            return;
        }
        a.recycle();
