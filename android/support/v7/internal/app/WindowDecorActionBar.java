...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C03393 implements ViewPropertyAnimatorUpdateListener {
        C03393() {
        }
    ...
    public WindowDecorActionBar(ActionBarActivity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C04621();
        this.mShowListener = new C04632();
        this.mUpdateListener = new C03393();
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0093R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0093R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0093R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0093R.id.action_bar_container);
        this.mSplitView = (ActionBarContainer) decor.findViewById(C0093R.id.split_action_bar);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0093R.styleable.ActionBar, C0093R.attr.actionBarStyle, CONTEXT_DISPLAY_NORMAL);
        if (a.getBoolean(C0093R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0093R.styleable.ActionBar_elevation, CONTEXT_DISPLAY_NORMAL);
        if (elevation != 0) {
    ...
    public void doShow(boolean fromSystem) {
        ...
        if (this.mCurWindowVisibility == 0 && ALLOW_SHOW_HIDE_ANIMATIONS && (this.mShowHideAnimationEnabled || fromSystem)) {
            ...
            ViewCompat.setAlpha(this.mContainerView, TextTrackStyle.DEFAULT_FONT_SCALE);
            ViewCompat.setTranslationY(this.mContainerView, 0.0f);
            if (this.mContentAnimations && this.mContentView != null) {
                ViewCompat.setTranslationY(this.mContentView, 0.0f);
            }
            if (this.mSplitView != null && this.mContextDisplayMode == CONTEXT_DISPLAY_SPLIT) {
                ViewCompat.setAlpha(this.mSplitView, TextTrackStyle.DEFAULT_FONT_SCALE);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0093R.attr.actionBarWidgetTheme, outValue, true);
