...
public class MenuBuilder implements SupportMenu {
    ...
    L_0x0014:
        r4 = r5.mItems;
        r4 = r4.get(r0);
        r4 = (android.support.v7.internal.view.menu.MenuItemImpl) r4;
        r4 = r4.getGroupId();
    ...
    L_0x002c:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v7.internal.view.menu.MenuBuilder.removeGroup(int):void");
    }
    ...
    private static int getOrdering(int categoryOrder) {
        ...
        if (index >= 0 && index < sCategoryToOrder.length) {
            return (sCategoryToOrder[index] << 16) | (GameRequest.TYPE_ALL & categoryOrder);
        }
    ...
    private void setShortcutsVisibleInner(boolean shortcutsVisible) {
        boolean z = true;
        if (!(shortcutsVisible && this.mResources.getConfiguration().keyboard != 1 && this.mResources.getBoolean(C0093R.bool.abc_config_showMenuShortcutsWhenKeyboardPresent))) {
            z = false;
        }
