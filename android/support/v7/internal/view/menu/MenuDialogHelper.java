...
public class MenuDialogHelper implements OnKeyListener, OnClickListener, OnDismissListener, Callback {
    ...
    public void show(IBinder windowToken) {
        ...
        this.mPresenter = new ListMenuPresenter(C0093R.layout.abc_list_menu_item_layout, C0093R.style.Theme_AppCompat_CompactMenu);
        ...
        lp.flags |= MetadataChangeSet.INDEXABLE_TEXT_SIZE_LIMIT_BYTES;
        this.mDialog.show();
    }
