...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent {
    ...
    class C00994 implements Runnable {
        C00994() {
        }
    ...
    static {
        ATTRS = new int[]{C0093R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context) {
        ...
        this.mRemoveActionBarHideOffset = new C00983();
        this.mAddActionBarHideOffset = new C00994();
        init(context);
    }
    ...
    public void onWindowSystemUiVisibilityChanged(int visible) {
        ...
        if ((visible & FileUploadPreferences.BATTERY_USAGE_UNRESTRICTED) != 0) {
            stable = true;
        } else {
            stable = false;
        }
        ...
        if ((diff & FileUploadPreferences.BATTERY_USAGE_UNRESTRICTED) != 0 && this.mActionBarVisibilityCallback != null) {
            ViewCompat.requestApplyInsets(this);
        }
    }
    ...
    protected boolean fitSystemWindows(Rect insets) {
        pullChildren();
        if ((ViewCompat.getWindowSystemUiVisibility(this) & FileUploadPreferences.BATTERY_USAGE_UNRESTRICTED) != 0) {
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        boolean stable = (ViewCompat.getWindowSystemUiVisibility(this) & FileUploadPreferences.BATTERY_USAGE_UNRESTRICTED) != 0;
        if (stable) {
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0093R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0093R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0093R.id.action_bar));
            this.mActionBarBottom = (ActionBarContainer) findViewById(C0093R.id.split_action_bar);
        }
    }
