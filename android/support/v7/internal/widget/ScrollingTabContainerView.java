...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemClickListener {
    ...
    private class TabView extends LinearLayoutCompat implements OnLongClickListener {
        ...
        public TabView(Context context, Tab tab, boolean forList) {
            super(context, null, C0093R.attr.actionBarTabStyle);
            this.BG_ATTRS = new int[]{16842964};
            this.mTab = tab;
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0093R.attr.actionBarTabStyle, 0);
            if (a.hasValue(0)) {
        ...
        public void update() {
            ...
            if (hasText) {
                if (this.mTextView == null) {
                    TextView textView = new CompatTextView(getContext(), null, C0093R.attr.actionBarTabTextStyle);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat tabLayout = new LinearLayoutCompat(getContext(), null, C0093R.attr.actionBarTabBarStyle);
    ...
    private SpinnerCompat createSpinner() {
        SpinnerCompat spinner = new SpinnerCompat(getContext(), null, C0093R.attr.actionDropDownStyle);
    ...
    public void animateToVisibility(int visibility) {
        ...
        if (visibility == 0) {
            ...
            ViewPropertyAnimatorCompat anim = ViewCompat.animate(this).alpha(TextTrackStyle.DEFAULT_FONT_SCALE);
    ...
    public void animateToTab(int position) {
        ...
        this.mTabSelector = new C01051(tabView);
    ...
    public void addTab(Tab tab, boolean setSelected) {
        ...
        this.mTabLayout.addView(tabView, new LayoutParams(0, -1, TextTrackStyle.DEFAULT_FONT_SCALE));
        if (this.mTabSpinner != null) {
    ...
    public void addTab(Tab tab, int position, boolean setSelected) {
        TabView tabView = createTabView(tab, false);
        this.mTabLayout.addView(tabView, position, new LayoutParams(0, -1, TextTrackStyle.DEFAULT_FONT_SCALE));
        if (this.mTabSpinner != null) {
            ((TabAdapter) this.mTabSpinner.getAdapter()).notifyDataSetChanged();
        }
        if (setSelected) {
