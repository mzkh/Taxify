...
class SpinnerCompat extends AbsSpinnerCompat implements OnClickListener {
    ...
    class C01062 implements OnGlobalLayoutListener {
        C01062() {
        }
    ...
    class C03421 extends ForwardingListener {
        final /* synthetic */ DropdownPopup val$popup;

        C03421(View x0, DropdownPopup dropdownPopup) {
    ...
    private class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        class C01071 implements OnItemClickListener {
            final /* synthetic */ SpinnerCompat val$this$0;

            C01071(SpinnerCompat spinnerCompat) {
        ...
        class C01082 implements OnGlobalLayoutListener {
            C01082() {
            }
        ...
        class C01093 implements OnDismissListener {
            final /* synthetic */ OnGlobalLayoutListener val$layoutListener;

            C01093(OnGlobalLayoutListener onGlobalLayoutListener) {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            setOnItemClickListener(new C01071(SpinnerCompat.this));
        }
        ...
        public void show(int textDirection, int textAlignment) {
            ...
            if (!wasShowing) {
                ViewTreeObserver vto = SpinnerCompat.this.getViewTreeObserver();
                if (vto != null) {
                    OnGlobalLayoutListener layoutListener = new C01082();
                    vto.addOnGlobalLayoutListener(layoutListener);
                    setOnDismissListener(new C01093(layoutListener));
                }
            }
        }
    }
    ...
    static class SavedState extends SavedState {
        ...
        static class C01101 implements Creator<SavedState> {
            C01101() {
            }
    ...
    SpinnerCompat(Context context, int mode) {
        this(context, null, C0093R.attr.spinnerStyle, mode);
    }

    SpinnerCompat(Context context, AttributeSet attrs) {
        this(context, attrs, C0093R.attr.spinnerStyle);
    }
    ...
    SpinnerCompat(Context context, AttributeSet attrs, int defStyle, int mode) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0093R.styleable.Spinner, defStyle, MODE_DIALOG);
        setBackgroundDrawable(a.getDrawable(C0093R.styleable.Spinner_android_background));
        if (mode == MODE_THEME) {
            mode = a.getInt(C0093R.styleable.Spinner_spinnerMode, MODE_DIALOG);
        }
        switch (mode) {
            case MODE_DIALOG /*0*/:
            ...
            case MODE_DROPDOWN /*1*/:
                ...
                this.mDropDownWidth = a.getLayoutDimension(C0093R.styleable.Spinner_android_dropDownWidth, -2);
                popup.setBackgroundDrawable(a.getDrawable(C0093R.styleable.Spinner_android_popupBackground));
                this.mPopup = popup;
                this.mForwardingListener = new C03421(this, popup);
                break;
        }
        this.mGravity = a.getInt(C0093R.styleable.Spinner_android_gravity, 17);
        this.mPopup.setPromptText(a.getString(C0093R.styleable.Spinner_prompt));
        this.mDisableChildrenWhenDisabled = a.getBoolean(C0093R.styleable.Spinner_disableChildrenWhenDisabled, false);
        a.recycle();
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        if (ss.showDropdown) {
            ...
            if (vto != null) {
                vto.addOnGlobalLayoutListener(new C01062());
            }
        }
    }
}
