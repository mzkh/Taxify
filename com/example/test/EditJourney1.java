...
public class EditJourney1 extends FragmentActivity implements OnAsyncRequestComplete1, OnClickListener, OnMapClickListener, OnMapReadyCallback, LocationListener {
    Button f8b;
    GoogleMap googleMap;
    int id;
    LatLng latLng;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.f8b = (Button) findViewById(C0132R.id.bgetloc);
    ...
    public void onClick(View v) {
        ...
        startActivity(new Intent(this, EditJourney2.class));
    }
