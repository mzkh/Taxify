...
public class InsertJourney2 extends FragmentActivity implements OnAsyncRequestComplete1, OnClickListener, OnMapClickListener, OnMapReadyCallback, LocationListener {
    Button f11b;
    GoogleMap googleMap;
    LatLng latLng;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.f11b = (Button) findViewById(C0132R.id.bgetloc);
    ...
    public void onClick(View v) {
        ...
        startActivity(new Intent(this, InsertJourney3.class));
    }
