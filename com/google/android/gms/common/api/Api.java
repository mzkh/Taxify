...
public final class Api<O extends ApiOptions> {
    ...
    public <C extends zza> Api(zzb<C, O> clientBuilder, zzc<C> clientKey, Scope... impliedScopes) {
        this.zzLS = clientBuilder;
        this.zzLT = clientKey;
        this.zzLU = new ArrayList(Arrays.asList(impliedScopes));
    }
