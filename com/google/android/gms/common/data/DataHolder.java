...
public final class DataHolder implements SafeParcelable {
    ...
    static class C03591 extends zza {
        C03591(String[] strArr, String str) {
            super(str, null);
        }
    }
    ...
    static {
        CREATOR = new zzf();
        zzOc = new C03591(new String[0], null);
    }
    ...
    private DataHolder(zza builder, int statusCode, Bundle metadata) {
        this(builder.zzNU, zza(builder, -1), statusCode, metadata);
    }
    ...
    public DataHolder(String[] columns, CursorWindow[] windows, int statusCode, Bundle metadata) {
        ...
        this.zzOb = true;
        this.zzFG = 1;
        this.zzNU = (String[]) zzx.zzl(columns);
        this.zzNW = (CursorWindow[]) zzx.zzl(windows);
        this.zzLs = statusCode;
        this.zzNX = metadata;
        zziy();
    }
