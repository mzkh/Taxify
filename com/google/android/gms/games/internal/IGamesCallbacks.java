...
public interface IGamesCallbacks extends IInterface {
        ...
        private static class Proxy implements IGamesCallbacks {
            ...
            public void zzE(DataHolder dataHolder) throws RemoteException {
                ...
                try {
                    ...
                    this.zzle.transact(ConnectionsStatusCodes.STATUS_ALREADY_ADVERTISING, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void zzd(int i, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    this.zzle.transact(ConnectionsStatusCodes.STATUS_ALREADY_DISCOVERING, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void zzey(int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.games.internal.IGamesCallbacks");
            ...
            public void zzez(int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.games.internal.IGamesCallbacks");
            ...
            public void zzp(DataHolder dataHolder) throws RemoteException {
                ...
                try {
                    ...
                    this.zzle.transact(ConnectionsStatusCodes.STATUS_ALREADY_CONNECTED_TO_ENDPOINT, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case FitnessStatusCodes.INCONSISTENT_DATA_TYPE /*5002*/:
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                    zzc(data.readInt() != 0 ? DataHolder.CREATOR.zzA(data) : null);
                    reply.writeNoException();
                    return true;
                ...
                case 12004:
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                    zza(data.readInt() != 0 ? DataHolder.CREATOR.zzA(data) : null, data.readInt() != 0 ? (Contents) Contents.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case 12005:
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                ...
                case 12017:
                    Contents contents;
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                    DataHolder zzA2 = data.readInt() != 0 ? DataHolder.CREATOR.zzA(data) : null;
    ...
    void zzex(int i) throws RemoteException;

    void zzey(int i) throws RemoteException;

    void zzez(int i) throws RemoteException;
