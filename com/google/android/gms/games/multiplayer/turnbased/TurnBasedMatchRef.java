...
public final class TurnBasedMatchRef extends zzd implements TurnBasedMatch {
    ...
    public ArrayList<Participant> getParticipants() {
        ArrayList<Participant> arrayList = new ArrayList(this.zzadF);
        for (int i = 0; i < this.zzadF; i++) {
            arrayList.add(new ParticipantRef(this.zzMd, this.zzNQ + i));
        }
        return arrayList;
    }
