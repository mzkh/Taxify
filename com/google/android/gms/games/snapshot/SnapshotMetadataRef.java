...
public final class SnapshotMetadataRef extends zzd implements SnapshotMetadata {
    private final Game zzaiU;
    private final Player zzakS;

    public SnapshotMetadataRef(DataHolder holder, int dataRow) {
        super(holder, dataRow);
        this.zzaiU = new GameRef(holder, dataRow);
        this.zzakS = new PlayerRef(holder, dataRow);
    }
    ...
    public Uri getCoverImageUri() {
        return zzbb("cover_icon_image_uri");
    }
