...
public interface zzbg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzbg {

        private static class zza implements zzbg {
        ...
        public static zzbg zze(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzbg)) ? new zza(iBinder) : (zzbg) queryLocalInterface;
        }
