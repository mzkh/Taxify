...
public interface zzbh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzbh {

        private static class zza implements zzbh {
        ...
        public static zzbh zzf(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzbh)) ? new zza(iBinder) : (zzbh) queryLocalInterface;
        }
