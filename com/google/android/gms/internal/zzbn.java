...
public interface zzbn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzbn {

        private static class zza implements zzbn {
        ...
        public static zzbn zzk(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzbn)) ? new zza(iBinder) : (zzbn) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case CompletionEvent.STATUS_FAILURE /*1*/:
                    ...
                    IBinder zza = zza(com.google.android.gms.dynamic.zzd.zza.zzau(data.readStrongBinder()), data.readInt());
