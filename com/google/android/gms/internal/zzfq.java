...
public interface zzfq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzfq {
        ...
        private static class zza implements zzfq {
            ...
            public IBinder zzc(zzd com_google_android_gms_dynamic_zzd) throws RemoteException {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case CompletionEvent.STATUS_FAILURE /*1*/:
                    ...
                    IBinder zzc = zzc(com.google.android.gms.dynamic.zzd.zza.zzau(data.readStrongBinder()));
                    reply.writeNoException();
                    reply.writeStrongBinder(zzc);
                    return true;
                case 1598968902:
    ...
    IBinder zzc(zzd com_google_android_gms_dynamic_zzd) throws RemoteException;
}
