...
public class zzkv<K, V> {
    ...
    public final synchronized String toString() {
        ...
        int i = 0;
        synchronized (this) {
            int i2 = this.zzQF + this.zzQG;
            if (i2 != 0) {
                i = (this.zzQF * 100) / i2;
            }
            format = String.format("LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.zzQB), Integer.valueOf(this.zzQF), Integer.valueOf(this.zzQG), Integer.valueOf(i)});
        }
        return format;
    }
    ...
    L_0x0043:
        ...
        goto L_0x0000;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzkv.trimToSize(int):void");
    }
}
