...
public class zzlo {
    ...
    private zzlo() {
        ...
        this.zzRx = new zzlr(Place.TYPE_SUBLOCALITY_LEVEL_2, ((Long) zza.zzRE.get()).longValue());
    }
    ...
    private static ServiceInfo zzb(Context context, Intent intent) {
        List queryIntentServices = context.getPackageManager().queryIntentServices(intent, TransportMediator.FLAG_KEY_MEDIA_NEXT);
