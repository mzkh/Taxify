...
public interface zzos extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzos {
        ...
        private static class zza implements zzos {
            ...
            public void zza(zzor com_google_android_gms_internal_zzor, UserAddressRequest userAddressRequest, Bundle bundle) throws RemoteException {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case CompletionEvent.STATUS_CONFLICT /*2*/:
                    ...
                    zza(com.google.android.gms.internal.zzor.zza.zzbe(data.readStrongBinder()), data.readInt() != 0 ? (UserAddressRequest) UserAddressRequest.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
    ...
    void zza(zzor com_google_android_gms_internal_zzor, UserAddressRequest userAddressRequest, Bundle bundle) throws RemoteException;
}
