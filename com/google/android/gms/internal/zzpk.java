...
public class zzpk implements SafeParcelable, Geofence {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.zzalS != com_google_android_gms_internal_zzpk.zzalS) {
            return false;
        }
        if (this.zzalQ != com_google_android_gms_internal_zzpk.zzalQ) {
            return false;
        }
        if (this.zzalR != com_google_android_gms_internal_zzpk.zzalR) {
            return false;
        }
        return this.zzalP == com_google_android_gms_internal_zzpk.zzalP;
    }
