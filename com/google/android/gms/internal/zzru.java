...
public interface zzru extends IInterface {

    public static abstract class zza extends Binder implements zzru {

        private static class zza implements zzru {
        ...
        public static zzru zzck(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzru)) ? new zza(iBinder) : (zzru) queryLocalInterface;
        }
