...
public interface zzsm extends IInterface {

    public static abstract class zza extends Binder implements zzsm {

        private static class zza implements zzsm {
            ...
            public void zzaG(Status status) throws RemoteException {
        ...
        public static zzsm zzco(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzsm)) ? new zza(iBinder) : (zzsm) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case CompletionEvent.STATUS_FAILURE /*1*/:
                    ...
                    zzaG(data.readInt() != 0 ? Status.CREATOR.createFromParcel(data) : null);
