...
public interface zzsv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzsv {
        ...
        private static class zza implements zzsv {
            ...
            public void zza(zzsu com_google_android_gms_internal_zzsu, Uri uri, Bundle bundle, boolean z) throws RemoteException {
                ...
                try {
                    ...
                    if (com_google_android_gms_internal_zzsu != null) {
                        iBinder = com_google_android_gms_internal_zzsu.asBinder();
                    }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case CompletionEvent.STATUS_FAILURE /*1*/:
                    ...
                    zza(com.google.android.gms.internal.zzsu.zza.zzcr(data.readStrongBinder()), data.readInt() != 0 ? (Uri) Uri.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, data.readInt() != 0);
                    return true;
                case 1598968902:
    ...
    void zza(zzsu com_google_android_gms_internal_zzsu, Uri uri, Bundle bundle, boolean z) throws RemoteException;
}
