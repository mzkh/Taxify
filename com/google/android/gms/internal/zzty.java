...
import com.google.android.gms.internal.zztw.zza;
import java.util.HashSet;
import java.util.Set;

public class zzty implements Creator<zza> {
    static void zza(zza com_google_android_gms_internal_zztw_zza, Parcel parcel, int i) {
        int zzK = zzb.zzK(parcel);
        Set set = com_google_android_gms_internal_zztw_zza.zzauX;
        if (set.contains(Integer.valueOf(1))) {
            zzb.zzc(parcel, 1, com_google_android_gms_internal_zztw_zza.zzFG);
        }
        if (set.contains(Integer.valueOf(2))) {
            zzb.zzc(parcel, 2, com_google_android_gms_internal_zztw_zza.zzawo);
        }
        if (set.contains(Integer.valueOf(3))) {
            zzb.zzc(parcel, 3, com_google_android_gms_internal_zztw_zza.zzawp);
        }
        zzb.zzH(parcel, zzK);
    }
