...
public class zzvc extends zzk<zzva> implements zzur {
    ...
    private static class zza extends com.google.android.gms.internal.zzuy.zza {
        ...
        class C02661 implements Runnable {
            ...
            C02661(zza com_google_android_gms_internal_zzvc_zza, List list, String str, zzva com_google_android_gms_internal_zzva) {
        ...
        class C02672 implements Runnable {
            ...
            C02672(zza com_google_android_gms_internal_zzvc_zza, String str, String str2, zzva com_google_android_gms_internal_zzva) {
                this.zzaxd = com_google_android_gms_internal_zzvc_zza;
                this.zzaxb = str;
                this.zzaxe = str2;
                this.zzaxc = com_google_android_gms_internal_zzva;
        ...
        public void zza(String str, String str2, zzva com_google_android_gms_internal_zzva) throws RemoteException {
            this.zzawZ.submit(new C02672(this, str, str2, com_google_android_gms_internal_zzva));
        }

        public void zza(String str, List<Scope> list, zzva com_google_android_gms_internal_zzva) throws RemoteException {
            this.zzawZ.submit(new C02661(this, list, str, com_google_android_gms_internal_zzva));
        }
    }
