...
public interface zzwc extends IInterface {

    public static abstract class zza extends Binder implements zzwc {

        private static class zza implements zzwc {
        ...
        public static zzwc zzcI(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzwc)) ? new zza(iBinder) : (zzwc) queryLocalInterface;
        }
