...
class zzwu implements Cloneable {
    ...
    public boolean equals(Object o) {
        ...
        zzwu com_google_android_gms_internal_zzwu = (zzwu) o;
        if (size() != com_google_android_gms_internal_zzwu.size()) {
            return false;
        }
        return zza(this.zzaHG, com_google_android_gms_internal_zzwu.zzaHG, this.mSize) && zza(this.zzaHH, com_google_android_gms_internal_zzwu.zzaHH, this.mSize);
    }
