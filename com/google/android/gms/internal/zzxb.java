...
public final class zzxb {
    ...
    public static boolean zzb(zzwq com_google_android_gms_internal_zzwq, int i) throws IOException {
        return com_google_android_gms_internal_zzwq.zzin(i);
    }

    public static final int zzc(zzwq com_google_android_gms_internal_zzwq, int i) throws IOException {
        int i2 = 1;
