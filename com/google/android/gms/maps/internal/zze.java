...
public interface zze extends IInterface {
    ...
    public static abstract class zza extends Binder implements zze {
        ...
        private static class zza implements zze {
            ...
            public Bitmap zza(zzl com_google_android_gms_maps_model_internal_zzl, int i, int i2) throws RemoteException {
                Bitmap bitmap = null;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case CompletionEvent.STATUS_FAILURE /*1*/:
                    ...
                    Bitmap zza = zza(com.google.android.gms.maps.model.internal.zzl.zza.zzcb(data.readStrongBinder()), data.readInt(), data.readInt());
    ...
    Bitmap zza(zzl com_google_android_gms_maps_model_internal_zzl, int i, int i2) throws RemoteException;
}
