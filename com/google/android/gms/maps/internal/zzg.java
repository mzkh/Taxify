...
public interface zzg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzg {
        ...
        private static class zza implements zzg {
            ...
            public void zza(zzj com_google_android_gms_maps_model_internal_zzj) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IOnIndoorStateChangeListener");
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case CompletionEvent.STATUS_CONFLICT /*2*/:
                    data.enforceInterface("com.google.android.gms.maps.internal.IOnIndoorStateChangeListener");
                    zza(com.google.android.gms.maps.model.internal.zzj.zza.zzbZ(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void zza(zzj com_google_android_gms_maps_model_internal_zzj) throws RemoteException;
}
