...
public interface zzh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzh {
        ...
        private static class zza implements zzh {
            ...
            public void zze(zzl com_google_android_gms_maps_model_internal_zzl) throws RemoteException {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case CompletionEvent.STATUS_FAILURE /*1*/:
                    ...
                    zze(com.google.android.gms.maps.model.internal.zzl.zza.zzcb(data.readStrongBinder()));
    ...
    void zze(zzl com_google_android_gms_maps_model_internal_zzl) throws RemoteException;
}
