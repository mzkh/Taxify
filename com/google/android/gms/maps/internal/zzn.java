...
public interface zzn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzn {
        ...
        private static class zza implements zzn {
            ...
            public boolean zza(zzl com_google_android_gms_maps_model_internal_zzl) throws RemoteException {
                boolean z = true;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case CompletionEvent.STATUS_FAILURE /*1*/:
                    ...
                    boolean zza = zza(com.google.android.gms.maps.model.internal.zzl.zza.zzcb(data.readStrongBinder()));
    ...
    boolean zza(zzl com_google_android_gms_maps_model_internal_zzl) throws RemoteException;
}
