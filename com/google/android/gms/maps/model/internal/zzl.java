...
public interface zzl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzl {
        ...
        private static class zza implements zzl {
            ...
            public void zzb(zza com_google_android_gms_maps_model_internal_zza) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IMarkerDelegate");
            ...
            public boolean zzh(zzl com_google_android_gms_maps_model_internal_zzl) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
        ...
        public static zzl zzcb(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case Place.TYPE_CAMPGROUND /*16*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                    isDraggable = zzh(zzcb(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isDraggable) {
                        i = 1;
                    }
                ...
                case Place.TYPE_CAR_RENTAL /*18*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                    zzn(com.google.android.gms.dynamic.zzd.zza.zzau(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                ...
                case Place.TYPE_DENTIST /*28*/:
                    ...
                    zzb(com_google_android_gms_maps_model_internal_zza);
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void zzb(zza com_google_android_gms_maps_model_internal_zza) throws RemoteException;

    boolean zzh(zzl com_google_android_gms_maps_model_internal_zzl) throws RemoteException;
