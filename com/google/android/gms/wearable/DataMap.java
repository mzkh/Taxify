...
public class DataMap {
    ...
    private final HashMap<String, Object> zzaFx;
    ...
    public static DataMap fromByteArray(byte[] bytes) {
        try {
            return zzwm.zza(new zza(zzwn.zzq(bytes), new ArrayList()));
        } catch (Throwable e) {
    ...
    public boolean containsKey(String key) {
        return this.zzaFx.containsKey(key);
    }
    ...
    public <T> T get(String key) {
        return this.zzaFx.get(key);
    }

    public Asset getAsset(String key) {
        Object obj = this.zzaFx.get(key);
        if (obj == null) {
            return null;
        }
        try {
    ...
    public void putAsset(String key, Asset value) {
        this.zzaFx.put(key, value);
    }

    public void putBoolean(String key, boolean value) {
        this.zzaFx.put(key, Boolean.valueOf(value));
    }

    public void putByte(String key, byte value) {
        this.zzaFx.put(key, Byte.valueOf(value));
    }
    ...
    public void putDouble(String key, double value) {
        this.zzaFx.put(key, Double.valueOf(value));
    }

    public void putFloat(String key, float value) {
        this.zzaFx.put(key, Float.valueOf(value));
    }
    ...
    public void putInt(String key, int value) {
        this.zzaFx.put(key, Integer.valueOf(value));
    }
    ...
    public void putLong(String key, long value) {
        this.zzaFx.put(key, Long.valueOf(value));
    }
